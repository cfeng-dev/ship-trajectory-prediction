...
def print_prior_report(priors: bayesian_model.BayesianCTRVPriors) -> None:
    ...
    print(
        "Prozessrauschen-Referenzintervall: "
        f"{bayesian_model.PROCESS_REFERENCE_INTERVAL_SECONDS:g} s\n"
    )
    _normal_report(
        "Anfangsgeschwindigkeit v_1",
        "v_1",
