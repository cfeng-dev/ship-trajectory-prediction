...
import ship_trajectory_prediction.models.bayesian_ctrv_state_space as state_space_model
...
@dataclasses.dataclass(frozen=True, slots=True)
class BayesianCTRVStateSpaceEvaluationOptions:
    """Runtime overrides for one Bayesian CTRV state-space evaluation."""
...
def parse_bayesian_ctrv_state_space_evaluation_arguments(
    *,
    description: str | None,
    experiment: state_space_forecasting.RollingExperimentConfig,
    priors: state_space_model.BayesianCTRVPriors,
    vi_config: Mapping[str, Any],
    max_windows: int | None,
    plot_each_window: bool,
    argv: Sequence[str] | None = None,
) -> BayesianCTRVStateSpaceEvaluationOptions:
    """Parse options for one Bayesian CTRV state-space rolling evaluation."""
    parser = argparse.ArgumentParser(description=description)
    parser.add_argument(
        "--window-mode",
        choices=("sliding", "expanding"),
    ...
    arguments = parser.parse_args(argv)
    return BayesianCTRVStateSpaceEvaluationOptions(
        window_mode=arguments.window_mode,
        observation_count=arguments.observations,
        prediction_count=arguments.predictions,
        stride=arguments.stride,
