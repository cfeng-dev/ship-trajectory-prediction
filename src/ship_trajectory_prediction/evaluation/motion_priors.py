"""Empirical motion-prior calibration and diagnostic plotting."""
...
DEFAULT_PLOT_CENTRAL_QUANTILE = 0.995
DEFAULT_HISTOGRAM_MODE = "density"  # Choose "density" or "frequency".
...
def collect_motion_prior_samples(
    ...
    *,
    run_ids=None,
    min_course_displacement_m=DEFAULT_MIN_COURSE_DISPLACEMENT_METERS,
    max_time_gap_s=DEFAULT_MAX_TIME_GAP_SECONDS,
) -> MotionPriorSamples:
...
def plot_motion_prior_distributions(
    ...
    *,
    central_quantile=DEFAULT_PLOT_CENTRAL_QUANTILE,
    histogram_mode=DEFAULT_HISTOGRAM_MODE,
