"""Run one Bayesian CTRV state-space trajectory prediction."""

import ship_trajectory_prediction.forecasting.bayesian_ctrv_state_space as config
import ship_trajectory_prediction.forecasting.bayesian_ctrv_state_space_workflow as workflow
...
def main(argv=None):
    ...
    arguments = cli.parse_bayesian_ctrv_state_space_prediction_arguments(
        description=__doc__,
