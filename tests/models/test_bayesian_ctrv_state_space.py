"""Tests for the preserved Bayesian CTRV state-space model interface."""
...
from ship_trajectory_prediction.models import bayesian_ctrv_state_space as model_module
