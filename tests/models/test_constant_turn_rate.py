...
def test_build_stan_data_uses_observed_data_only_for_priors():
    """Stan prior centers should be derived from observed history."""
    ...
    assert stan_data["heading_prior_mean"] == pytest.approx(0.5)
