"""Tests for the Bayesian CTRV state-space single-window entry point."""

import experiments.trajectory_prediction.bayesian_ctrv_state_space as experiment
...
def test_main_delegates_visible_experiment_configuration(monkeypatch):
    ...
    assert captured == {
        ...
        "fullrank_grad_samples": experiment.inference.DEFAULT_FULLRANK_GRAD_SAMPLES,
